...
const ebook = () => {
  ...
  return (
    <SafeAreaView className="h-full">
      <ScrollView>
        <ContentHeader text={"Browse Ebooks"} icon={"fa-book-open"} />
        <View className="flex-row items-center justify-center mx-4  p-2">
          <TouchableOpacity activeOpacity={0.35}>
            <View className=" border-b-2 border-[#FF9100] items-center mx-6 p-4">
              <Text className="font-primaryBold text-xl">All</Text>
            </View>
          </TouchableOpacity>
          <TouchableOpacity activeOpacity={0.35}>
            <View className=" items-center mx-4 mr-8 p-4">
